...
| --- | --- | --- | --- | --- | --- | --- |
| dynamic_multi_lora | - | 1199 | 260.7 | 1398.3 | 2.00 | num_switch_commits=1, fast_path_share=0.6363636363636364 |
...
| system | hot_ratio | num_requests | mean_latency_ms | p99_latency_ms | throughput (req/s) | notes |
| --- | --- | --- | --- | --- | --- | --- |
| dynamic_multi_lora | 0.00 | 100 | 281.5 | 1265.6 | 3.55 | fast_path_share=0.0, num_switch_commits=0 |
| dynamic_multi_lora | 0.40 | 100 | 191.3 | 1212.4 | 5.22 | fast_path_share=0.4, num_switch_commits=0 |
| dynamic_multi_lora | 0.80 | 100 | 182.5 | 1253.2 | 5.47 | fast_path_share=0.8, num_switch_commits=0 |
| dynamic_multi_lora | 1.00 | 100 | 114.5 | 545.8 | 8.72 | fast_path_share=1.0, num_switch_commits=0 |
...
| system | hot_ratio | num_requests | mean_latency_ms | p99_latency_ms | throughput (req/s) | notes |
| --- | --- | --- | --- | --- | --- | --- |
| dynamic_multi_lora[thrash_guarded] | - | 240 | 259.7 | 1230.3 | 3.85 | num_switch_commits=0 |
| dynamic_multi_lora[thrash_naive] | - | 240 | 263.0 | 1270.4 | 3.80 | num_switch_commits=1 |
